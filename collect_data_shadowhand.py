...
from env_shadowhand import Env
...
ROBOT_URDF = os.path.join(HERE, 'data', 'shadowhand', 'urdf', 'movable_shadowhand.urdf')
...
gripper_main_control_joint_name = ["WRJ2",
                    "WRJ1",
                    "FFJ4",
                    "FFJ3",
                    "FFJ2",
...
try:
    ...
    env.close_gripper(env.robotID, env.joints, gripper_main_control_joint_name, mimic_joint_name, 1.2, 0.4)
